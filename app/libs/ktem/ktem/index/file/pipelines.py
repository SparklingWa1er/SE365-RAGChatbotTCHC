...
class DocumentRetrievalPipeline(BaseFileIndexRetriever):
    ...
    def get_user_settings(cls) -> dict:
        ...
        return {
            ...
            "retrieval_mode": {
                "name": "Retrieval mode",
                # "hybrid" (vector + BM25) chạy được nhờ vá LanceDBDocumentStore.query
                # (bỏ prefilter khi scope lớn — xem storages/docstores/lancedb.py).
                # Nếu vẫn gặp Rust panic, hạ về "vector" để né LanceDB FTS.
                "value": "hybrid",
