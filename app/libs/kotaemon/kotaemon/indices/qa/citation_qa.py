...
# Prompt QA chuyên biệt (component dự án) — tách ra rag/prompts.py cho dễ chỉnh
# và dễ thấy phần custom. Xem rag/prompts.py::DEFAULT_QA_DOMAIN_PROMPT.
from rag.prompts import DEFAULT_QA_DOMAIN_PROMPT  # noqa: E402

DEFAULT_QA_TEXT_PROMPT = DEFAULT_QA_DOMAIN_PROMPT
DEFAULT_QA_TABLE_PROMPT = DEFAULT_QA_DOMAIN_PROMPT
