...
\usepackage{weekly}
\begin{document}
\weekheader{3}{13/06 \textendash{} 22/06/2026}{Agentic RAG, Tích hợp và Minh bạch hoá}{w3col}{Đang hoàn thiện}
...
\begin{itemize}[label={}]
  ...
  \cbWip Đánh giá agentic so với baseline (độ chính xác, độ phủ nguồn) và phân tích lỗi.
\end{itemize}

\noindent Hướng tuần kế tiếp: tổng quát hoá tầng LLM để chạy đa nhà cung cấp (Azure, OpenAI,
vLLM) và hoàn thiện báo cáo.
